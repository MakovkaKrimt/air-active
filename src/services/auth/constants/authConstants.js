...
export const FORM_LABELS = {
    ...
    HELPERS: {
        [INPUT_TYPES.NEW_USERNAME]: 'Придумайте имя пользователя, содержащее английские буквы и цифры общей длиной более 3 символов',
        [INPUT_TYPES.NEW_PASSWORD]: 'Придумайте пароль, содержащий как минимум одну цифру, одну прописную и одну строчную букву общей длиной более 8 символов',
